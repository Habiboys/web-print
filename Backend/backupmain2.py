...
def print_file():
    try:
        ...
        orientation = options.get('orientation', 'portrait')  # Menambahkan opsi orientasi
        ...
        # Menambahkan orientasi halaman (portrait atau landscape)
        if orientation == 'landscape':
            # Modifikasi orientasi menggunakan ReportLab atau alat lain sesuai kebutuhan
            # Di sini, Anda bisa menggunakan ReportLab untuk mengubah ukuran halaman ke Landscape
            from reportlab.lib.pagesizes import landscape, letter
            from reportlab.pdfgen import canvas

            # Membuat PDF dengan orientasi landscape
